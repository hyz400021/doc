...
const DOMAIN_NAME = 'hyz400021.github.io/doc/' // 域名 (不带https)
//hyz400021.github.io/doc/
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo:
        '黄元治 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      ...
      // {
        // 是否支持第三方搜索链接，默认false
        // support: false,
        // 搜索链接，默认['Google', 'Baidu', 'Bing', 'Yahoo', 'Sogou', 'Exploratory']
        // search: ['Baidu', 'Exploratory'],
      // },
      // 'thirdparty-search',
      // {
      //   thirdparty: [
